function login() {
  ...
  const url =
    role === "doctor"
      ? "https://hospital-management-system-production-b610.up.railway.app/api/doctors/login"
      : "https://hospital-management-system-production-b610.up.railway.app/api/users/login";
...
function registerUser() {
  ...
  fetch(
    "https://hospital-management-system-production-b610.up.railway.app/api/users/register",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
