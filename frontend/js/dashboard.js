...
const url =
  role === "doctor"
    ? `https://hospital-management-system.railway.internal/api/dashboard/doctor/${userId}`
    : `https://hospital-management-system.railway.internal/api/dashboard/patient/${userId}`;
